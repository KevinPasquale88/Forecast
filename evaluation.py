import numpy as np
import pandas as pd
from function import models_all, plot_boxplots, plot_confusion, plot_roc_comparison, plot_mean_ci, plot_family_comparison
...
def evaluate_results():
    ...
    plot_family_comparison(bootstrap_results)
    # save final summary table
    df_summary = pd.DataFrame(summary_rows)
    plot_mean_ci(df_summary)
